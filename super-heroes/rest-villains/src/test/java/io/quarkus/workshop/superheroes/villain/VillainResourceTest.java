...
public class VillainResourceTest {
    ...
    private static final String UPDATED_POWERS = "does nort eat pain au chocolat (updated)";
    private static final int DEFAULT_LEVEL = 42;
    private static final int UPDATED_LEVEL = 43;

    private static final int NB_VILLAINS_MIN = 570;
    private static String villainId; // must be uninitialized
    ...
    void shouldGetInitialItems() {
        ...
        assertTrue(villains.size() >= NB_VILLAINS_MIN);
    }
    ...
    void shouldAddAnItem() {
        List<Villain> villains = get("/api/villains").then()
            ...
            .contentType(APPLICATION_JSON)
            .extract().body().as(getVillainTypeRef());
        final int NB_VILLAINS = villains.size();
        ...
        villains = get("/api/villains").then()
            .statusCode(OK.getStatusCode())
            .contentType(APPLICATION_JSON)
            .extract().body().as(getVillainTypeRef());
    ...
    void testUpdatingAnItem() {
        ...
        Villain villain = new Villain();
        villain.id = villains.get(0).id; // update the first item
    ...
    void shouldRemoveAnItem() {
        ...
        // delete the first villain
        given()
            .pathParam("id", villains.get(0).id)
